...
public class StringsJoinPerfomanceApp {
	...
	public static void main(String[] args) {
		...
		StringsJoinPerformance testBuilder = getTest(array, N_RUNS, 
				"test of StringsJoinBuilder", new StringsJoinBuilder());
		StringsJoinPerformance testOperator = getTest(array, N_RUNS,
				"test of StringsJoinOperator", new StringsJoinOperator());
		testBuilder.run();
		testOperator.run();
	}
